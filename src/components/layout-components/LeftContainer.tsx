        ...
        <>
            {res == "asdsadasdwq" ?
                <div id="drawer" className="flex flex-col items-center md:w-[250px] w-full fixed top-0 bottom-0 !-left-[300%] left-0 md:!left-0 z-10 bg-cont-150 text-cont-125 transition-all duration-300">
                    ...
                    <Link onClick={e => { e.stopPropagation(); handleDrawer("close"); setIsLogged("") }} to="/home" className="w-full flex py-3 ps-6 hover:bg-[#3e4049] absolute bottom-5"><SvgLogout fillColor="#60626E" /> Logout</Link>
                </div> : ""
            }
            {res == "shop" ?
                <div id="drawer" className="flex flex-col items-center md:w-[250px] w-full fixed top-0 bottom-0 !-left-[300%] left-0 md:!left-0 z-10 bg-cont-150 text-cont-125 transition-all duration-300">
