        ...
        <>
            {location.pathname.includes("/p/") ?
                <div className="flex flex-col items-center w-[250px] fixed top-0 bottom-0 left-0 bg-cont-150 text-cont-125">
                    ...
                    <Link to="/p/home" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/home" || location.pathname == "/home/" ? ("bg-[#3e4049]") : ""}`}><SvgHome fillColor={location.pathname == "/home" || location.pathname == "/home/" ? "#fff" : "#60626E"} /> Home</Link>
                    <Link to="/p/loan" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/loan" || location.pathname == "/loan/" ? ("bg-[#3e4049]") : ""}`}><SvgLoan fillColor={location.pathname == "/loan" || location.pathname == "/loan/" ? "#fff" : "#60626E"} /> Loan</Link>
                    <Link to="/p/return" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/return" || location.pathname == "/return/" ? ("bg-[#3e4049]") : ""}`}><SvgReturn fillColor={location.pathname == "/return" || location.pathname == "/return/" ? "#fff" : "#60626E"} /> Return</Link>
                    <Link to="/p/containers" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/containers" || location.pathname == "/containers/" ? ("bg-[#3e4049]") : ""}`}><SvgContainers fillColor={location.pathname == "/containers" || location.pathname == "/containers/" ? "#fff" : "#60626E"} /> Containers</Link>
                    ...
                    <Link to="/p/support" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/support" || location.pathname == "/support/" ? ("bg-[#3e4049]") : ""}`}><SvgSupport fillColor={location.pathname == "/support" || location.pathname == "/support/" ? "#fff" : "#60626E"} /> Support</Link>
            ...
            {location.pathname.includes("/sp/") ?
                <div className="flex flex-col items-center w-[250px] fixed top-0 bottom-0 left-0 bg-cont-150 text-cont-125">
                    <h1 className="text-5xl text-cont-100 mt-6 mb-12">Admin</h1>
                    <Link to="/sp/home" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/home" || location.pathname == "/home/" ? ("bg-[#3e4049]") : ""}`}><SvgHome fillColor={location.pathname == "/home" || location.pathname == "/home/" ? "#fff" : "#60626E"} /> Home</Link>
                    <Link to="/sp/shop" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/shop" || location.pathname == "/shop/" ? ("bg-[#3e4049]") : ""}`}><SvgShop fillColor={location.pathname == "/shop" || location.pathname == "/shop/" ? "#fff" : "#60626E"} /> Shop List</Link>
                    <div className="cursor-pointer flex w-full py-3 ps-6 hover:bg-[#3e4049]" onClick={() => handleDropDown()} >Request's Container</div>
                    <Link to="/sp/requests?page=pending" id="item2" className={`w-full flex ps-10 hover:bg-[#3e4049] transition-all duration-200 h-0 opacity-0 invisible ${page == "pending" ? ("bg-[#3e4049]") : ""}`}><SvgContainers fillColor={page == "pending" ? "#fff" : "#60626E"} /> Pending Requests</Link>
                    <Link to="/sp/requests?page=accepted" id="item3" className={`w-full flex ps-10 hover:bg-[#3e4049] transition-all duration-200 h-0 opacity-0 invisible ${page == "accepted" ? ("bg-[#3e4049]") : ""}`}><SvgContainers fillColor={page == "accepted" ? "#fff" : "#60626E"} /> Accepted Requests</Link>
                    <Link to="/sp/qr" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/qr" || location.pathname == "/qr/" ? ("bg-[#3e4049]") : ""}`}><SvgQR fillColor={location.pathname == "/qr" || location.pathname == "/qr/" ? "#fff" : "#60626E"} /> QR generator</Link>
                    <Link to="/p/support" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/support" || location.pathname == "/support/" ? ("bg-[#3e4049]") : ""}`}><SvgSupport fillColor={location.pathname == "/support" || location.pathname == "/support/" ? "#fff" : "#60626E"} /> Support</Link>
                    <Link to="/sp/home" className="w-full flex py-3 ps-6 hover:bg-[#3e4049] absolute bottom-5"><SvgLogout fillColor="#60626E" /> Logout</Link>
                </div>
                : ""}
        </>
    )
