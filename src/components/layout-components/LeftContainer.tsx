        ...
        <>
            ...
            {location.pathname.includes("/sp/") ?
                <div className="flex flex-col items-center w-[250px] fixed top-0 bottom-0 left-0 bg-cont-150 text-cont-125">
                    ...
                    <Link to="/sp/shop" className={`w-full flex py-3 ps-6 hover:bg-[#3e4049] ${location.pathname == "/shop" || location.pathname == "/shop/" ? ("bg-[#3e4049]") : ""}`}><SvgShop fillColor={location.pathname == "/shop" || location.pathname == "/shop/" ? "#fff" : "#60626E"} /> ShopList</Link>
